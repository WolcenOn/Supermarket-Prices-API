...
func main() {
    ...
    family := flag.String("family", "all", "product family: all, rice, milk, vegetables, or ham")
    ...
    switch familyName {
    case "all", "rice", "milk", "vegetables", "ham":
    default:
        log.Fatalf("unsupported family %q; expected all, rice, milk, vegetables, or ham", familyName)
    }
